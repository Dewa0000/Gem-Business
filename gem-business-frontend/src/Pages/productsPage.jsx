                  ...
                  <div key={product._id} className="flex flex-col gap-3 pb-3">
                    ...
                    <div className="flex gap-2 px-4">
                      <button
                        type="button"
                        onClick={() => {}}
                        className="flex-1 min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-2.5 bg-[#22d760] text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#18b64a] transition-colors"
                      >
