                                ...
                                products.map((product) => (
                                    <div key={product.id} className="flex flex-col gap-3 pb-3">
                                        ...
                                        <div className="flex gap-3 px-4 py-3">
                                            <button
                                                type="button"
                                                className="flex flex-1 min-w-[84px] max-w-[480px] items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#39e079] text-[#122118] text-sm font-bold leading-normal tracking-[0.015em]"
                                            >
