...
const Header = () => {
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#366347] px-10 py-3">
      <div className="flex items-center gap-4 text-white">
        ...
        <h2 className="text-white text-lg font-bold leading-tight tracking-[-0.015em]">Luxe Gems</h2>
      </div>
      ...
      <div className="flex flex-1 justify-end gap-8">
        ...
        <div className="flex gap-2">
          {/* Search Button */}
          <button className="flex items-center justify-center h-10 px-2.5 rounded-lg bg-[#1b3124] text-white text-sm font-bold">
          ...
          <Link
            to="/login"
            className="flex items-center justify-center h-10 px-2.5 rounded-lg bg-[#1b3124] text-white text-sm font-bold gap-2"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
